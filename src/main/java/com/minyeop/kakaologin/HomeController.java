package com.minyeop.kakaologin;
...
public class HomeController {
	...
	@RequestMapping(value = "/javascript.do", method = RequestMethod.GET)
	public String javascriptapi() {
	...
	public String kakaoLogin(Model model, @RequestParam(value = "code", required = false) String code,
		...
		System.out.println("카카오 인증서버로 부터 받아온 인증코드 : " + code);

		System.out.println("state: " + state);

		
		String access_Token = getAccessToken(code);
		if (state != null && state.equals("javascript")) { // 자바스크립트에서의 카카오 응답인지 확인
		...
		System.out.println("###image#### : " + userInfo.get("profile_image"));

		System.out.println("id: " + userInfo.get("client_id"));
